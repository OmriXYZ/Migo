...
public class PowerBall {
    ...
    public PowerBall(World world, float x, float y, float radius, boolean isRight, float speed) {
        ...
        body.createFixture(bodyFixture).setUserData("POWERBALL");
        body.setUserData("POWERBALL");
        if (isRight) {
